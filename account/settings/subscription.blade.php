...
@section('content')
    ...
    @if( $plan->isActive() )
        ...
        <div class="m-b-30">
            <a href="{{ URL::action('AccountController@getSettingsSubscriptionPause') }}"
               class="button button--regular button--light button--rounded m-r-10">{{ trans('account.home.button-pause') }}</a>
            ...
            <div class="content_section">
                ...
                <div class="extra_content">
                    ...
                    <div class="description">
                        ...
                        <div class="m-t-20 m-b-10"><a href="#"
                                                      class="seeIngredientsBtn">{{ trans('flow-actions.see-ingredients') }}</a>
                        </div>
